...
%% EVAL SPDE AND LGCP POSTERIOR SAMPLING OF barplot k function

\clearpage %sort out figure placements later

\section{Communication of Results}

% This is not quite right - model communication?  
% in Results add a section evaluating SPDE using boxplot k function 
